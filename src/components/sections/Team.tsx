...
export const Team = ({ members }: Props) => {
      ...
      <div className="mt-[10.2rem] w-full">
        <div className="relative before:absolute before:inset-0 before:bg-[radial-gradient(ellipse_50%_50%_at_center,rgba(var(62,36,118),0.1),transparent)]">
          <Container className="w-[78rem] max-w-[90%] text-center">
            <h2 className="text-gradient relative z-10 mb-11 translate-y-[40%] text-center text-6xl [transition:transform_1000ms_cubic-bezier(0.3,1.17,0.55,0.99)0s] md:text-8xl [.is-visible_&]:translate-y-0">
        ...
        <Container className="w-[78rem] max-w-[90%] text-center text-white mt-10 relative z-10">
          <>
